...
const RecruiterRegisterPage = () => {
  const [formData, setFormData] = useState({
    ...
    companyName: '', companySize: '', industry: '', companyWebsite: '', phone: '',
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const userData = {
        ...
        company: formData.companyName, phone: formData.phone,
      };
      ...
      <div className="auth-card">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <input type="email" id="email" name="email" className="form-control" placeholder="you@company.com" value={formData.email} onChange={handleChange} required />
          </div>
          <div className="form-group">
          ...
          <div className="form-group">
            ...
            <input type="text" id="companyName" name="companyName" className="form-control" placeholder="Acme Labs" value={formData.companyName} onChange={handleChange} required />
          </div>
          <div className="form-group">
            <label htmlFor="companySize">Company size</label>
            <select id="companySize" name="companySize" className="form-control" value={formData.companySize} onChange={handleChange}>
          ...
          <div className="form-group">
            ...
            <select id="industry" name="industry" className="form-control" value={formData.industry} onChange={handleChange}>
          ...
          <div className="form-group">
            ...
            <input type="url" id="companyWebsite" name="companyWebsite" className="form-control" placeholder="https://example.com" value={formData.companyWebsite} onChange={handleChange} />
          </div>
          <div className="form-group">
            <label htmlFor="phone">Phone</label>
            <input type="tel" id="phone" name="phone" className="form-control" placeholder="+91 90000 00000" value={formData.phone} onChange={handleChange} />
          </div>
        ...
        <div className="social-login">
          <GoogleAuthButton role="recruiter" mode="register" onError={setError} onSuccess={(user) => navigate(authService.getDefaultRoute(user))} />
        </div>
