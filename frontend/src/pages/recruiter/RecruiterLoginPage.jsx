      ...
      <div className="auth-card">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="forgot-password">
            <Link to="/recruiter/forgot-password" className="auth-link">Forgot Password?</Link>
          </div>
        ...
        <div className="auth-footer">
          Don't have an account? <Link to="/recruiter/register" className="auth-link">Register here</Link>
        </div>
      </div>
    </div>
  );
