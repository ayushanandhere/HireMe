...
const RecruiterLoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.success) navigate('/dashboard/recruiter');
    } catch (err) {
      ...
      <div className="auth-card">
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            ...
            <input type="email" id="email" className="form-control" placeholder="you@company.com" value={email} onChange={(e) => setEmail(e.target.value)} disabled={loading} />
          </div>
          <div className="form-group">
            <label htmlFor="password">Password</label>
            <input type="password" id="password" className="form-control" placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)} disabled={loading} />
          </div>
